...
- - - *BOT INFO* - - -
    ...
    - Host : *[ ${os.hostname()} ]*
    - Owner : *[ @${628885960825} ]*
    - Instagram : *[ Instagram.com/akmalz.real ]*
    - Official Web : *[ Akmalz-Ganteng.dvnz99.repl.co ]*
    
    -  Fitur Error : *[ ${global.error.length} ]*
    
      *SUPPORT:*
       @${6289649480997} - Recode
       @${628885960825} - Recode
       @${62813309603730} - Creator
       @${0} - WhatsApp
...
- - - *Random Image* - - - 
-✎ *${p+=1}.* ${prefix}randomimage *cecan*
-✎ *${p+=1}.* ${prefix}randomimage *cogan*
-✎ *${p+=1}.* ${prefix}randomimage *bts*
-✎ *${p+=1}.* ${prefix}randomimage *exo*
-✎ *${p+=1}.* ${prefix}randomimage *estetik*
-✎ *${p+=1}.* ${prefix}randomimage *blackpink*
-✎ *${p+=1}.* ${prefix}randomimage *waifu*
-✎ *${p+=1}.* ${prefix}randomimage *husbu*
-✎ *${p+=1}.* ${prefix}randomimage *loli*
-✎ *${p+=1}.* ${prefix}randomimage neko*
-✎ *${p+=1}.* ${prefix}randomimage *elf*
-✎ *${p+=1}.* ${prefix}randomimage *shota*
-✎ *${p+=1}.* ${prefix}randomimage *sadgirl*
-✎ *${p+=1}.* ${prefix}randomimage *nimeart*
-✎ *${p+=1}.* ${prefix}randomimage *wallnime*
...
- - - *Sticker* - - -
-✎ *${p+=1}.* ${prefix}stickerwm *text|author*
-✎ *${p+=1}.* ${prefix}takestick *text|author*
-✎ *${p+=1}.* ${prefix}toimg 
-✎ *${p+=1}.* ${prefix}togif 
-✎ *${p+=1}.* ${prefix}semoji *emote*
-✎ *${p+=1}.* ${prefix}ttp *text*
-✎ *${p+=1}.* ${prefix}attp *text*
