...
`
         ...
         Client.cmd.on('cecan', async(data) => {
          ...
          sec.push({
            "rows": [
              ...
              {
                "title": "source code", 
                "description": "Source Code This Bot", 
                "rowId": `${data.prefix}sc`
               },
              {
                "title": "Bryan Group",
                "description": "whatsapp group to get information about bryanbot",
          	...
          	let po = client.prepareMessageFromContent(data.from, {
                  ...
                  "description": `${configs.botname} By BryanRfly`,
    ...
    try {
    if (data.isGroup) {
      data.reply('Untuk Menghindari Anti link Pada Bot Lain Maka Link Grup BryanBot Akan Di Kirim Melalui Chat Pribadi!')
      client.sendMessage(data.sender, `*Link Grup BryanBot*\n\nhttps://chat.whatsapp.com/C9azc9XSbbeDZ7nNAmkCOl\nSilahkan Masuk Ya Kak ${data.pushname}`, MessageType.text, {quoted: data.message}) 
    } else client.sendMessage(data.from, `*Link Grup BryanBot*\n\nhttps://chat.whatsapp.com/C9azc9XSbbeDZ7nNAmkCOl\nSilahkan Masuk Ya Kak ${data.pushname}`, MessageType.text, {quoted: data.message}) 
    } catch(e) {
      data.reply('' + e)
    }
  })
